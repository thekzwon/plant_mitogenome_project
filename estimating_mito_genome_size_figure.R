...
mapped_mt_contigs <- read_csv("865_documents_contigs_with_mt_genes.csv")

mapped_mt_contigs


###import datasets#####
s_conica_contigs_file <- read_csv("contig_csvs/silene_conica_contigs.csv")
Silene_noctiflora_contigs_file <- read_csv("contig_csvs/Silene_noctiflora.csv")
Silene_latifolia_contigs_file <- read_csv("contig_csvs/Silene_latifolia.csv")
silene_vulgaris_contigs_file <- read_csv("contig_csvs/svu_contigs.csv")
Silene_undulata_contigs_file <- read_csv("contig_csvs/Sun_contigs.csv")
agrostemma_githago_contigs_file <- read_csv("contig_csvs/agithago_contigs.csv")
aragoa_abietina_contigs_file <- read_csv("contig_csvs/Aab_contigs.csv")
aragoa_cleefii_contigs_file <- read_csv("contig_csvs/Acl_contigs.csv")
Plantago_arenaria_contigs_file <- read_csv("contig_csvs/pare.csv")
Plantago_aristata_contigs_file <- read_csv("contig_csvs/Par_contigs.csv")
Plantago_crassifolia_contigs_file <- read_csv("contig_csvs/Pcr_contigs.csv")
Plantago_depressa_contigs_file <- read_csv("contig_csvs/Pde_contigs.csv")
Plantago_coronopus_contigs_file <- read_csv("contig_csvs/Pco_contigs_copy.csv")
Plantago_elongata_contigs_file <- read_csv("contig_csvs/Pel_contigs.csv")
Plantago_maritima_contigs_file <- read_csv("contig_csvs/Pma_contigs.csv")
Plantago_media_contigs_file <- read_csv("contig_csvs/Pme_contigs.csv")
Plantago_rigida_contigs_file <- read_csv("contig_csvs/Pri_contigs.csv")
Plantago_rugelli_contigs_file <- read_csv("contig_csvs/Pru_contigs.csv")
Plantago_sericea_contigs_file <- read_csv("contig_csvs/Pse_contigs.csv")
Plantago_tenuiflora_contigs_file <- read_csv("contig_csvs/Pte_contigs.csv")
Melianthus_villosus_contigs_file <- read_csv("contig_csvs/Mel_contigs.csv")
california_macrophylla_contigs_file <- read_csv("contig_csvs/CMA_contigs.csv")
erodium_chrysanthum_contigs_file <- read_csv("contig_csvs/Ech_contigs.csv")
erodium_gruinum_contigs_file <- read_csv("contig_csvs/EGR_contigs.csv")
erodium_moschatum_contigs_file <- read_csv("contig_csvs/Emo_contigs.csv")
erodium_texanum_contigs_file <- read_csv("contig_csvs/Ete_contigs.csv")
erodium_trifolium_contigs_file <- read_csv("contig_csvs/ETR_contigs.csv")
Francoa_sonchifolia_contigs_file <- read_csv("contig_csvs/Fso_contigs.csv")
Geranium_brycei_contigs_file <- read_csv("contig_csvs/GBR_contigs.csv")
Geranium_incanum_contigs_file <- read_csv("contig_csvs/GIM_contigs.csv")
Geranium_maderense_contigs_file <- read_csv("contig_csvs/Gmr_contigs.csv")
Geranium_phaeum_contigs_file <- read_csv("contig_csvs/GPM_contigs.csv")
Geranium_sanguineum_contigs_file <- read_csv("contig_csvs/GSN_contigs.csv")
Hypeseocharis_bilobata_contigs_file <- read_csv("contig_csvs/HYP_contigs.csv")
Monsonia_emarginata_contigs_file <- read_csv("contig_csvs/MON_contigs.csv")
Pelargonium_australe_contigs_file <- read_csv("contig_csvs/PAS_contigs.csv")
Pelargonium_citronellum_contigs_file <- read_csv("contig_csvs/Pci_contigs.csv")
Pelargonium_cotyledonis_contigs_file <- read_csv("contig_csvs/Pco_contigs.csv")
Pelargonium_exstipulatum_contigs_file <- read_csv("contig_csvs/PEX_contigs.csv")
Pelargonium_fulgidum_contigs_file <- read_csv("contig_csvs/PFM_contigs.csv")
Pelargonium_myrrhifolium_contigs_file <- read_csv("contig_csvs/PMY_contigs.csv")
Pelargonium_nanum_contigs_file <- read_csv("contig_csvs/PNM_contigs.csv")
Pelargonium_tetragonum_contigs_file <- read_csv("contig_csvs/PTT_contigs.csv")
Pelargonium_transvaalense_contigs_file <- read_csv("contig_csvs/PTV_contigs.csv")
Pelargonium_x_hortorum_contigs_file <- read_csv("contig_csvs/PHR_contigs.csv")
Viviania_marifolia_contigs_file <- read_csv("contig_csvs/VMR_contigs.csv")
Podocarpus_macrophyllus_contigs_file <- read_csv("contig_csvs/Pod_spades_contigs.csv")
picea_abies_contigs_file <- read_csv("contig_csvs/pab_contigs.csv")
Taxus_baccata_contigs_file <- read_csv("contig_csvs/Tba_contigs.csv")
Viviania_marifolia_contigs_file <- read_csv("contig_csvs/VMR_contigs.csv")
Welwitschia_mirabilis_contigs_file <- read_csv("contig_csvs/Wel_spades_contigs.csv")
Zamia_integrifolia_contigs_file <- read_csv("contig_csvs/Zin_contigs.csv")
Ginkgo_biloba_contigs_file <- read_csv("contig_csvs/Gin_spades_contigs.csv")
Gnetum_gnemon_contigs_file <- read_csv("contig_csvs/Ggn_contigs.csv")
Hesperocyparis_glabra_contigs_file <- read_csv("contig_csvs/Hgl_contigs.csv")
abies_sibirica_contigs_file <- read_csv("contig_csvs/Abi_spades_contigs.csv")
ceratozamia_hildae_contigs_file <- read_csv("contig_csvs/chi_contigs.csv")
cupressus_sempervirens_contigs_file <- read_csv("contig_csvs/cse_contigs.csv")
Arabidopsis_thaliana_contigs_file <- read_csv("contig_csvs/arabidopsis_thaliana.csv")
Nicotiana_tabacum_contigs_file <- read_csv("contig_csvs/Nicotiana_tabacum.csv")
Zea_mays_contigs_file <- read_csv("contig_csvs/Zea_mays.csv")
...
####### correlation figures####
correaltion <- read_csv("correlation_02_16_23.csv")
